  ...
  plugins: [
    ...
    federation({
      ...
      shared: {
        ...
        // Shared as a singleton with the shell so a language change made anywhere in
        // the app is reflected here instantly — see src/i18n/index.ts.
