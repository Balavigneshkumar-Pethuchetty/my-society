...
_SERVICE_DIR = _HERE.parents[1]        # services/user
...
# Required (no default in app/config.py) — never actually called from these tests, since
# nothing here exercises the Keycloak Admin API role-sync path.
os.environ.setdefault("KEYCLOAK_ADMIN_PASSWORD", "test_keycloak_admin_password")
os.environ.setdefault("UPLOADS_DIR", tempfile.mkdtemp(prefix="user-test-uploads-"))
